...
namespace Csharp._3._osa___Failitöötlus
{
    internal class MainClass_3osa
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"C:\Users\annao\source\repos\Csharp\3. osa - Failitöötlus\Kuud.txt"); //@"..\..\..\Kuud.txt"
            ...
            try
            {
                path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"C:\Users\annao\source\repos\Csharp\3. osa - Failitöötlus\Kuud.txt");
